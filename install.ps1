...
$GITHUB_SOURCE_BRANCH = if ($SourceBranch) { $SourceBranch } elseif ($env:OCS_RELEASE_BRANCH) { $env:OCS_RELEASE_BRANCH } else { "staging/v2.1.12" }
$DEFAULT_RELEASE_BRANCH = "staging/v2.1.12"
