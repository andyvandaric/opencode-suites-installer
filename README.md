...
```bash
curl -fsSL https://raw.githubusercontent.com/andyvandaric/opencode-suites-installer/staging/v2.2.1/install.sh | bash -s -- --version 2.2.1
```
...
```powershell
pwsh -NoProfile -ExecutionPolicy Bypass -Command '$env:OCS_VERSION = "2.2.1"; irm https://raw.githubusercontent.com/andyvandaric/opencode-suites-installer/staging/v2.2.1/install.ps1 | iex'
```
