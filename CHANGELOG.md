...
- `8a31941` chore(installer): sync scripts from opencode-config-suites
- `2ef77a8` chore(installer): sync scripts from opencode-config-suites
- `e465aa8` chore(installer): sync scripts from opencode-config-suites
